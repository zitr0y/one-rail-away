...
export function riderSvg(stroke: string, hollow: string): string {
  ...
  <circle cx="65.36" cy="80" r="4" stroke="${stroke}" stroke-width="3" fill="${hollow}"/>
  <circle cx="119.74" cy="80" r="4" stroke="${stroke}" stroke-width="3" fill="${hollow}"/>
  ...
  <path d="M48 46 H100" stroke="${stroke}" stroke-width="2" stroke-dasharray="1 7"
        stroke-linecap="round"/>
  <text x="84.42" y="70" font-size="15" fill="#ffcc00" stroke="#eab308"
